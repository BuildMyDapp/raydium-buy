...
export async function saveBuyTx( mint_address: string, pool_address:string,tx_hash: string | undefined,sol_amount:number,amount: number,  timestamp: number) {
    try {
        const tx = await sql(`
...
export async function saveSellTx( mint_address: string,pool_address:string,  tx_hash: string|undefined,sol_amount:number,amount: number,  timestamp: number) {
    try {
        const tx = await sql(`
